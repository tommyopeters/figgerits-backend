...
const Prompt = `Generate a CSV with two columns. The first column is each word in the array [${selectedWords.join(', ')}]. The second column is a cryptic hint for the word not more than 6 words.`;
